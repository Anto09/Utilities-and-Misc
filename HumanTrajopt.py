...
if __name__ == "__main__":
    ...
    print len(ht.cost_regions)
    print ht.cost_regions[0].vertices
    print ht.cost_regions[1].vertices
    config = np.array([10, 1, 0, 20, 0, 0, 30])
    cr_ins = ht.cost_regions[ht.get_region_inside(config)]
    cr = ht.get_lowest_cost_region(config)
    print 'inside vertices'
    print cr_ins.vertices
    print 'inside cost'
    print cr_ins.total_cost
